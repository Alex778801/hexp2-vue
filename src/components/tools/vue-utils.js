// -----------------------------------------------------------------------------------
// БИБЛИОТЕКА вспомогательных функций и утилит
// -----------------------------------------------------------------------------------
...
// Обработчик фатальных ошибок сервера
export function fErr(msg) {
   const body = document.getElementsByTagName('body');
   body[0].innerHTML = "Fatal Error! <br>" + msg;
   clog('fErr: ', msg);
}
...
// Мобильный (или десктопный браузер)?
